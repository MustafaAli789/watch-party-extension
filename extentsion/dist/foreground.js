...
const establishSocketConnection = (newRoomData, sendResponse) => {
    ...
    let roomId = guid();
    let joinRoomData = { roomName: newRoomData.roomName, userName: newRoomData.userName, roomId: roomId, action: constants_2.RoomAction.CREATE };
    socket.emit(constants_2.SocketEvents.JOIN, joinRoomData, (err) => {
        alert(err);
    });
    socket.on(constants_2.SocketEvents.CREATED_ROOM, (data) => {
        sendResponse({
