...
const createChatComponent = (roomName, socket, curUser) => {
    ...
    input.addEventListener('keydown', (key) => {
        if (key.code === 'Enter' && input.value.trim().length > 0) {
            let msg = { user: curUser, content: input.value, timestamp: getHourAndMinFormatted() };
