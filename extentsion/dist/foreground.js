...
const createChatComponent = (roomName) => {
...
const updateChat = (messages, curUser) => {
    let messagesContianer = document.querySelector('.messages');
...
const createSocketConnection = (roomData, sendResponse) => {
    ...
    socket.on(constants_2.SocketEvents.TO_EXT_ROOM_DATA, (data) => {
        ...
        if (currentRoom === null) { // initial room join
            ...
            foregroundUi_1.createChatComponent(currentRoom.roomName);
            ...
            foregroundUi_1.updateChat([initWelcomeMsg], getCurUser(currentRoom));
        }
