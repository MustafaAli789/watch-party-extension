...
const createSocketConnection = (roomData, sendResponse, joinChannelEvent) => {
    ...
    socket.on(constants_2.SocketEvents.USER_CONNECTED, (data) => {
        chrome.runtime.sendMessage({
            message: constants_1.Messages.TOPOPUP_USER_CONNECTED,
            payload: { message: data.message }
        });
    });
    socket.on(constants_2.SocketEvents.USER_DISCONNECTED, (data) => {
    });
};
