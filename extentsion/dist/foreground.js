        ...
        if (msg.type === "IMG") {
            ...
            lastImg.addEventListener('click', () => {
                chrome.runtime.sendMessage({
                    message: constants_2.Messages.TOBG_OPEN_IMG_IN_TAB,
                    payload: lastImg.src
                });
            });
        }
