...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.message === constants_1.Messages.TOFG_VIDEO_ON_SCREEN) {
        ...
        foregroundUi_1.addNotif({ headerMsg: 'Offset Time Set', bodyMsg: "Successfully set offset time to " + newOffsetTime, type: 'SUCCESS' });
        algorithmicVideoEventHappened.seek = true;
