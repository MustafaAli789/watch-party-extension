...
const establishSocketConnectionForNewRoom = (newRoomData, sendResponse) => {
    ...
    createSocketConnection(roomData, sendResponse, constants_2.SocketEvents.CREATED_ROOM);
};
const establishSocketConnectionForExistingRoom = (joinRoomData, sendResponse) => {
    ...
    createSocketConnection(roomData, sendResponse, constants_2.SocketEvents.JOINED_ROOM);
};
const createSocketConnection = (roomData, sendResponse, joinChannelEvent) => {
    vidElem.onplay = function () {
        if (socketVideoEventHappened)
            return;
    ...
    socket.on(joinChannelEvent, (data) => {
    ...
    socket.on(constants_2.SocketEvents.VIDEO_EVENT, (videoEventData) => {
        ...
        setTimeout(() => socketVideoEventHappened = false, 1000);
    });
};
